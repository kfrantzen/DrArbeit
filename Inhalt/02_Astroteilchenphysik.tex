...
Größere Energien als $5\cdot10^{19} \si{eV}$ können aufgrund des GZK-Cutoffs \cite{Greisen}\cite{ZatsepinKuzmin} theoretisch nicht gemessen werden. 
...
Abhängig vom Energiebereich gibt es verschiedene Detektoren.
